...
class _WelcomeViewState extends State<WelcomeView> {
  ...
  child: Padding(
    ...
    child: Column(
      ...
      children: [
        RichText(
          text: TextSpan(
            style: TextStyle(color: textColorMid, fontSize: 14),
            children: [
              TextSpan(text: "Login with Social Media"),
            ],
          ),
        ),
        SizedBox(height: 8), // Boşluk ekleyerek logoları metinden ayırıyoruz
        Row(
  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
  mainAxisSize: MainAxisSize.min, // Row'un en küçük boyutu almasını sağlar
  children: [
    SizedBox( // FlutterSocialButton'ın boyutunu sınırlamak için SizedBox kullanıyoruz
      width: 48, // İstenilen genişlik
      height: 48, // İstenilen yükseklik
  ...
  style: ElevatedButton.styleFrom(
    ...
    shape: RoundedRectangleBorder(
      ...
      side: BorderSide(color: kPrimaryColor, width: 2), // Dış çerçeve rengi ve kalınlığı
    ),
